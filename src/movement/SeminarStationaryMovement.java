 ...
 */
public class SeminarStationaryMovement extends MovementModel {
    /** Per node group setting for setting the location ({@value}) */
    public static final String LOCATION_S = "seminarLocationsFile";
    ...
    static {
        DTNSim.registerForReset(SeminarStationaryMovement.class.getCanonicalName());
        reset();
    }
     ...
     */
    public SeminarStationaryMovement(Settings s) {
        super(s);

        String courseLocationsFile = s.getSetting(LOCATION_S);
     ...
     */
    public SeminarStationaryMovement(SeminarStationaryMovement sm) {
        super(sm);
        this.id = nextID++;
        this.loc = sm.allSeminars.get(this.id);
    }
    ...
    @Override
    public SeminarStationaryMovement replicate() {
        return new SeminarStationaryMovement(this);
    }
