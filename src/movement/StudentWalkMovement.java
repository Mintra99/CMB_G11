 ...
 * @author Frans Ekman
 */
public class StudentWalkMovement extends MapBasedMovement implements
     ...
     * @param settings
     */
    public StudentWalkMovement(Settings settings) {
        super(settings);
     ...
     * @param proto
     */
    public StudentWalkMovement(StudentWalkMovement proto) {
        super(proto);
