 ...
 */
public class LibraryStationaryMovement extends MovementModel {
    /** Per node group setting for setting the location ({@value}) */
    public static final String LOCATION_S = "libraryLocationsFile";
    ...
    static {
        DTNSim.registerForReset(LibraryStationaryMovement.class.getCanonicalName());
        reset();
    }
     ...
     */
    public LibraryStationaryMovement(Settings s) {
        super(s);
//		this.id = nextID++;
     ...
     */
    public LibraryStationaryMovement(LibraryStationaryMovement sm) {
        super(sm);
        this.id = nextID++;
        this.loc = sm.allLibraries.get(this.id);
    }
    ...
    @Override
    public LibraryStationaryMovement replicate() {
        return new LibraryStationaryMovement(this);
    }
